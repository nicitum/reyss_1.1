      ...
      {loadingToken || loadingUsers ? (
        ...
        <ScrollView style={styles.scrollView}>
          {assignedUsers.map((user) => {
            ...
            return (
              <View key={user.customer_id} style={styles.card}>
                ...
                <View style={styles.orderInfo}>
                  <View style={styles.orderSection}>
                    ...
                    <Text style={styles.orderStatus}>{placementError[user.customer_id] || getOrderStatusDisplay(amOrderStatus)}</Text>
                    <View
                      style={[
                        styles.todayStatus,
                  ...
                  <View style={styles.orderSection}>
                    ...
                    <Text style={styles.orderStatus}>{placementError[user.customer_id] || getOrderStatusDisplay(pmOrderStatus)}</Text>
                    <View
                      style={[
                        styles.todayStatus,
